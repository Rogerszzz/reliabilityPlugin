...
myWriter.writerow(
    ['creepmax1', 'creepmax2', 'creepmax3', 'fatiguemax1', 'fatiguemax2', 'fatiguemax3', 'totalmax1', 'totalmax2',
     'totalmax3'])
for i in range(1, 201):
    print('processing NO.%d ODB' % i)
    odb = openOdb(path='D:\\ABAQUSWORKDIR\\6.14\\reiability\\job%d.odb' % i)
